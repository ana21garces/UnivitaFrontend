...
import { ChevronDown, ChevronUp, Users, HeartHandshake, AlertCircle, Building2, GraduationCap, Bell, Check, XCircle } from "lucide-react"
      ...
      {open && (
        <div className="px-4 pb-4 pt-2 bg-[#F8FAFC] border-t border-[#E2E8F0]">
          <div className="sm:hidden mb-3">
            <p className="text-xs font-medium text-[#6B7280] mb-1">Índice RI</p>
