...
export function ManualEstudiante() {
  return (
    <>
      <div>
        <Link
      ...
      >
        <p>
          ...
          <strong>practicarse todos los días</strong>, hasta que se vuelvan costumbre. Por eso vas a
          ver instrucciones del tipo «durante siete días seguidos» o «cada vez que comas», y por eso
          el seguimiento es diario.
        </p>
        <p>
          ...
          veces anotas un número (los minutos que caminaste, los vasos de agua) o escribes una frase
          corta.
        </p>
        <p>
