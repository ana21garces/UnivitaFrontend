...
export function UniVitaLogo({ size = "md" }: { size?: "xs" | "nav" | "sm" | "md" | "lg" }) {
  const dims = size === "xs" ? "w-8 h-8" : size === "nav" ? "w-12 h-12" : size === "sm" ? "w-20 h-20" : size === "lg" ? "w-40 h-40" : "w-32 h-32"
  const ringSize = size === "xs" ? "w-10 h-10" : size === "nav" ? "w-14 h-14" : size === "sm" ? "w-24 h-24" : size === "lg" ? "w-44 h-44" : "w-36 h-36"
